            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Registros de inicio de sesión para los empleados, cada empleado tiene su propia función.
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="tblTop">
                                    ...
                                    <div>
                                        <a class="btn btn-success" href="add/anadirEmpleado.php">Nuevo</a>
                                    </div>
                                </div>
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var fila = "<tr>" +
                            ...
                            "<td style='text-align:center'>" + empleado.apellido_paterno + " " + empleado.apellido_materno + "</td>" +
                            "<td style='text-align:center'>" + empleado.correo + "</td>" +
                            "<td style='text-align:center'>" + empleado.telefono + "</td>" +
                            "<td style='text-align:center'>" + empleado.descripcion + "</td>" +
                            "<td style='text-align:center'>" + (empleado.estado == 1 ? 'Activo' : 'Inactivo') + "</td>" +
                            "<td style='text-align:center'>" + (empleado.estado == 0 ? '<button class=\'btn btn-danger\' onclick=\'eliminarEmpleado(' + empleado.id_empleado + ')\'><i class=\'fas fa fa-refresh\'></i></button>' : '<button class=\'btn btn-danger\' onclick=\'eliminarEmpleado(' + empleado.id_empleado + ')\'><i class=\'fas fa fa-trash\'></i></button>') + " <a href='edit/editarEmpleado.php?id=" + empleado.id_empleado + "' class='btn btn-info'><i style='color:#fff;' class='fas fa fa-edit'></i></a>" +
                            "</td>" +
                            "</tr>";
                        tablaUsuarios.append(fila);
                    }
                } else {
                    tablaUsuarios.append("<tr><td colspan='9'>No se encontraron empleados.</td></tr>");
                }
            }
