            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="margin-bottom:2rem;" class="mt-4">Registro de Clientes</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="formularioAdd">
                                    <form id="formularioUsuario" class="needs-validation" novalidate onsubmit="guardarCliente(event)" >
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputName">Nombre</label>
                                                <input type="text" class="form-control inputUser" id="inputName" placeholder="Nombre" required>
                                                <div class="invalid-feedback">Por favor ingresa un nombre válido.</div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputCi">N° Cedula</label>
                                                <input type="number" class="form-control inputUser" id="inputCi" placeholder="Ci" required>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control inputUser" id="inputApellido1" placeholder="Apellido Paterno" required>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control inputUser" id="inputApellido2" placeholder="Apellido Materno" required>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" class="form-control inputUser" id="inputEmail4" placeholder="Email" required>
                                                <div class="invalid-feedback">Por favor ingresa un email válido.</div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputTelefono">Telefono</label>
                                                <input type="number" class="form-control inputUser" id="inputTelefono" placeholder="Telefono" required>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control inputUser" id="inputEdad" placeholder="Edad" required>
