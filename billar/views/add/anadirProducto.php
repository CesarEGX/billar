            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="margin-bottom:2rem;" class="mt-4">Registro de producto</h1>
                            ...
                            <div class="card-body">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <span>-No se podrá eliminar productos que tengan registros con las reservas .</span></br>
                                    </div>
                                </div>
                                <div class="">
                                ...
                                <div class="formularioAdd">
                                    <form id="formularioUsuario" class="needs-validation" novalidate onsubmit="guardarProducto(event)" >
                                        <div class="form-row">
                                            <input type="hidden" id="id_empleado" value="<?php echo $id_empleado ?>" >
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4">Nombre del producto</label>
                                                <input type="text" class="form-control inputUser" id="inputProducto" required>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control inputUser" id="inputCantidad" required>
