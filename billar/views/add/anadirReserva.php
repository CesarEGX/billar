                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="formularioAdd">
                                    <form id="formularioUsuario" class="needs-validation" novalidate onsubmit="guardarReserva(event)" >
                                        <div class="form-row">
                                                    ...
                                                    <?php
                                                        if($resultado -> num_rows > 0){
                                                            while($row = $resultado->fetch_assoc()){
                                                                echo "<option value='".$row["id_cliente"]."'>".$row["nombre"]." ".$row["apellido_paterno"]."  /  Ci:".$row['ci']." </option>";
                                                            }
                                                        }else{
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="date" class="form-control inputUser" id="inputFechaSolicitud" value="<?php echo $fechaHoy; ?>" required readonly>
                                                <div class="invalid-feedback">Por favor ingresa una fecha válida.</div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputApellido2">Fecha de Alquiler</label>
                                                <input type="date" class="form-control inputUser" id="inputFechaAlquiler" required>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="time" class="form-control inputUser" id="inputHoraInicio" required>
                                                <div class="invalid-feedback">Por favor ingresa una hora válida</div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputTelefono">Hora a Finalizar</label>
                                                <input type="time" class="form-control inputUser" id="inputHoraFin"  required>
                                                <div class="invalid-feedback">Por favor ingresa una hora válida.</div>
                                            </div>
