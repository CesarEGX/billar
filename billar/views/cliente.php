            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Registros clientes para reservas de mesas.
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="tblTop">
                                    ...
                                    <div>
                                        <a class="btn btn-success" href="add/anadirCliente.php">Nuevo</a>
                                    </div>
                                </div>
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var fila = "<tr>" +
                            ...
                            "<td style='text-align:center'>" + cliente.apellido_paterno + " " + cliente.apellido_materno + "</td>" +
                            "<td style='text-align:center'>" + cliente.correo + "</td>" +
                            "<td style='text-align:center'>" + cliente.telefono + "</td>" +
                            "<td style='text-align:center'>" + '<button class=\'btn btn-danger\' onclick=\'eliminarCliente(' + cliente.id_cliente + ')\'><i class=\'fas fa fa-trash\'></i></button>' + " <a href='edit/editarCliente.php?id=" + cliente.id_cliente + "' class='btn btn-info'><i style='color:#fff;' class='fas fa fa-edit'></i></a>" +
                            "</td>" +
                            "</tr>";
                        tablaClientes.append(fila);
                    }
                } else {
                    tablaClientes.append("<tr><td style='text-align:center' colspan='6'>No se encontraron clientes.</td></tr>");
                }
            }
