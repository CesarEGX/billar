...
<html lang="en">
    ...
    <?php
        ...
        $sql = "SELECT * FROM tipo_producto WHERE id_tipo_producto = '$id_categoria'";
        $resultado = $conexion -> query($sql);
        if($resultado -> num_rows > 0){
            while($dataUsuario = $resultado -> fetch_assoc()){
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="margin-bottom:2rem;" class="mt-4">Editar categoria</h1>
                            ...
                            <div class="card-body">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <span>-No se podrá eliminar las categorias que esten relacionados con otros registros.</span></br>
                                    </div>
                                </div>
                                <div class="">
                                ...
                                <div class="formularioAdd">
                                    <form id="formularioUsuario" class="needs-validation" novalidate onsubmit="editarCategoria(event)" >
                                        <div class="form-row">
                                            <input type="hidden" id="id_categoria" value="<?php echo $id_categoria; ?>">
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4">Nombre de la categoria</label>
                                                <input type="text" class="form-control inputUser" id="inputCategoria" required value="<?php echo $descripcion ?>">
                                        ...
                                        <div style="display:flex;flex-direction:row;margin-top:2.5rem;" class="">
                                            ...
                                            <a href="../categoria.php" style="margin-left:2rem;" class="btn btn-dark">Cancelar</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
