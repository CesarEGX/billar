...
<html lang="en">
    ...
    <?php
        //consulta del que inicio sesion, no tocar
    ...
    <?php
        $id_cliente = $_GET['id'];
        $query = "SELECT cliente.id_cliente,persona.ci,persona.nombre,persona.apellido_paterno,persona.apellido_materno,persona.correo,persona.telefono,persona.edad
                    FROM persona
                    INNER JOIN  cliente ON persona.id_persona = cliente.id_personaLF WHERE cliente.id_cliente = '$id_cliente'";
        $resultado = $conexion -> query($query);
        if($resultado -> num_rows > 0){
            while($dataCliente = $resultado -> fetch_assoc()){
                $nombreEdit = $dataCliente['nombre'];
                $apellido_paternoEdit = $dataCliente['apellido_paterno'];
                $apellido_maternoEdit = $dataCliente['apellido_materno'];
                $ci = $dataCliente['ci'];
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="margin-bottom:2rem;" class="mt-4">Editar Cliente</h1>
                            ...
                            <div class="card-body">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <span>-Los clientes se registraran para la reserva .</span></br>
                                        <span>-No puedes eliminar un cliente que ya ha tenido reservas.</span>
                                    </div>
                                </div>
                                <div class="">
                                ...
                                <div class="formularioAdd">
                                    <form id="formularioUsuario" class="needs-validation" novalidate onsubmit="editarCliente(event)" >
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <input type="hidden" id="inputID" value="<?php echo $id_cliente; ?>">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control inputUser" id="inputCi" placeholder="Ci" required value="<?php echo $ci ?>">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" class="form-control inputUser" id="inputEmail4" placeholder="Email" required value="<?php echo $correo ?>">
                                                <div class="invalid-feedback">Por favor ingresa un email válido.</div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputTelefono">Telefono</label>
                                                <input type="number" class="form-control inputUser" id="inputTelefono" placeholder="Telefono" required value="<?php echo $telefono ?>">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control inputUser" id="inputEdad" placeholder="Edad" required value="<?php echo $edad ?>">
                                        ...
                                        <div style="display:flex;flex-direction:row;margin-top:2.5rem;" class="">
                                            ...
                                            <a href="../cliente.php" style="margin-left:2rem;" class="btn btn-dark">Cancelar</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
