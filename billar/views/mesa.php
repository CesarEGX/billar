            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="margin-bottom:2rem;" class="mt-4">Registro de Mesas</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                                Registros Mesas para que se registre el cliente al hacer una reserva
                            </div>
                        </div>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="tblTop">
                                    ...
                                    <div>
                                        <button class="btn btn-success" onclick="AgregarMesa(event)" >Nuevo</button>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr class="titulosTabla">
                                                <th style="text-align:center" scope="col">Nro de Mesa</th>
            ...
            function updateTable(data) {
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        var mesa = data[i];
                        var fila = "<tr>" +
                            "<td style='text-align:center'>" + mesa.numero_mesa + "</td>" +
                            "<td style='text-align:center'>" + (mesa.estado == 1 ? 'Activo' : 'Inactivo') + "</td>" +
                            "<td style='text-align:center'><img src='" + rutaImagenes + "mesaBillarBD.jpg' width='40'></td>" + // Cambia "nombre_de_la_imagen.jpg" por el nombre real de la imagen
                            "<td style='text-align:center'>" + (mesa.estado == 0 ? '<button class=\'btn btn-danger\' onclick=\'eliminarMesa(' + mesa.id_mesa + ')\'><i class=\'fas fa fa-refresh\'></i></button>' : '<button class=\'btn btn-danger\' onclick=\'eliminarMesa(' + mesa.id_mesa + ')\'><i class=\'fas fa fa-trash\'></i></button>') +
                            "</td>" +
                            "</tr>";
                        tablaClientes.append(fila);
                    }
                } else {
                    tablaClientes.append("<tr><td style='text-align:center' colspan='4'>No se encontraron mesas.</td></tr>");
                }
            }
