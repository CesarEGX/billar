            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="margin-bottom:2rem;" class="mt-4">Registro de Categorias</h1>
                        <div class="card mb-4">
                            <div class="card-body">
                                Registra las categorias para los productos.
                            </div>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                <a style="text-decoration:none;color:#212529" href="producto.php" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">Productos</a> / <a style="text-decoration:none;color:#212529" href="marca.php" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">Marcas</a> /  <a style="text-decoration:underline;color:#212529" href="categoria.php">Categorias</a>
                            </div>
                            <div class="card-body">
                                <div class="tblTop">
                                    <div>
                                    ...
                                    <div>
                                        <a href="add/anadirCategoria.php" class="btn btn-success" >Nuevo</a>
                                    </div>
                                </div>
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var fila = "<tr>" +
                            ...
                            "<td style='text-align:center'>" + '<button class=\'btn btn-danger\' onclick=\'eliminarCategoria(' + categoria.id_tipo_producto + ')\'><i class=\'fas fa fa-trash\'></i></button>' + " <a href='edit/editarCategoria.php?id=" + categoria.id_tipo_producto + "' class='btn btn-info'><i style='color:#fff;' class='fas fa fa-edit'></i></a>" +
                            "</td>" +
                            "</tr>";
                        tablaClientes.append(fila);
                    }
                } else {
                    tablaClientes.append("<tr><td style='text-align:center' colspan='2'>No se encontraron categorias.</td></tr>");
                }
            }
